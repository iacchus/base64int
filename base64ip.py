...
class Base64IP:
    ...
    def ip_to_base64(self, ip_str):
        ...
        self.bitmap_list = [self._byte_to_bitmap(byte)
        ...
        self.b64_ip = str().join([TABLE[index] for index
                                  in self.b64_index_integer])
        self.b64_ip += self.padding
